import { c as D, r as G, n as _t, o as ht, q as Y } from "./index-8f8a42cc.js";
/*!
...
var P, W, X, at, O, ct = function() {
    ...
    wt = function(t, e, o, l, f, i) {
        var r = e.length,
            s = 0,
            c = Math.min(t.size || C(t), e[o].size || C(e[o])) * l,
            u = gt,
            _ = t.centerX + f,
            n = t.centerY + i,
            a, d, p, g, h;
        for (d = o; d < r && (a = e[d].size || C(e[d]), !(a < c)); d++)
            p = e[d].centerX - _,
            g = e[d].centerY - n,
            h = T(p * p + g * g),
            h < u && (s = d,
    ...
    E = function(t, e, o, l, f) {
        var i = e.length - t.length,
            ...
            s = i > 0 ? t : e,
            c = 0,
            u = l === "complexity" ? xt : et,
            _ = l === "position" ? 0 : typeof l == "number" ? l : .8,
            n = s.length,
            a = typeof o == "object" && o.push ? o.slice(0) : [o],
            d = a[0] === "reverse" || a[0] < 0,
            p = o === "log",
            g, h, x, m, y, M, w;
        if (s[0]) {
    ...
    nt = function(t, e, o, l, f) {
        var i = D(t[0]),
            r = D(t[1]);
        E(i, r, e || e === 0 ? e : "auto", o, f) && (t[0] = G(i),
            t[1] = G(r),
    ...
    zt = function(t, e, o) {
        var l = typeof t == "string",
            f, i;
        return (!l || dt.test(t) || (t.match(v) || []).length < 3) && (f = W(t)[0],
    ...
    lt = "Use MorphSVGPlugin.convertToPath() to convert to a path before morphing.",
    Ft = function(t, e, o, l) {
        var f = this._origin,
            i = this._eOrigin,
            r = t[o] - f.x,
        ...
        return r = e[o] - i.x,
            s = e[o + 1] - i.y,
            _ = b(s, r) - u,
            n = bt(_), !l && X && Math.abs(n + X.ca) < ut && (l = X),
            this._anchorPT = X = {
    ...
    j = {
        ...
        init: function(t, e, o, l, f) {
            ...
            var $ = t.nodeType ? window.getComputedStyle(t) : {},
                J = $.fill + "",
                pt = !(J === "none" || (J.match(v) || [])[3] === "0" || $.fillRule === "evenodd"),
                H = (e.origin || "50 50").split(",");
            if (i = (t.nodeName + "").toUpperCase(),
                u = i === "POLYLINE" || i === "POLYGON",
                i !== "PATH" && !u && !e.prop)
                return z("Cannot morph a <" + i + "> element. " + lt), !1;
            if (r = i === "PATH" ? "d" : "points", !e.prop && !U(t.setAttribute))
                return !1;
            if (c = zt(e.shape || e.d || e.points || "", r === "d", t),
                u && mt.test(c))
                return z("A <" + i + "> cannot accept path data. " + lt), !1;
            if (_ = e.shapeIndex || e.shapeIndex === 0 ? e.shapeIndex : "auto",
                ...
                if (this._target = t,
                    ...
                    p = this._prop ? t[this._prop] : t.getAttribute(r), !this._prop && !t.getAttributeNS(null, "data-original") && t.setAttributeNS(null, "data-original", p),
                    r === "d" || this._prop) {
                    if (p = D(w ? e.precompile[0] : p),
                        g = D(w ? e.precompile[1] : c), !w && !E(p, g, _, n, pt))
                        return !1;
                    for ((e.precompile === "log" || e.precompile === !0) && z('precompile:["' + G(p) + '","' + G(g) + '"]'),
...
export { j as M };
//# sourceMappingURL=MorphSVGPlugin-a74cfb3c.js.map